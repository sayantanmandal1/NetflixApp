    ...
    >
      <div className="flex items-center justify-between px-4 md:px-14 h-[68px]">
        ...
        <div className="flex items-center gap-6">
          <Link href="/browse" className="focus:outline-none focus:ring-2 focus:ring-white rounded">
            <svg viewBox="0 0 111 30" className="h-[25px] md:h-[35px] w-auto fill-[#e50914]" aria-label="Netflix">
